        ...
        <div>
          <div className="mb-10">
            ...
            <p className="mt-3 text-base text-muted-foreground max-w-md">
              Enter your website URL and we&apos;ll audit it, then generate an upgraded version
              with improved messaging, clearer copy, and better conversion. From there, you can
              build it with Maxwell or request a proposal.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-6xl px-4">
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] lg:gap-16">
            <div>
              ...
              <div className="h-4 w-96 max-w-full rounded bg-muted animate-pulse mb-10" />
